...
class KRTVApplication : Application() {
    ...
    companion object {
        private const val TAG = "KRTVApplication"
        private lateinit var instance: KRTVApplication

        @JvmStatic
        fun getInstance(): KRTVApplication {
            return instance
        }
    }
    ...
    override fun onCreate() {
        ...
        Thread.setDefaultUncaughtExceptionHandler(KRTVExceptionHandler(this))
