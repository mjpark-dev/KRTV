...
import dev.mjpark.krtv.data.Global.typeSourceList
import dev.mjpark.krtv.data.ReqSettings
import dev.mjpark.krtv.data.ReqSourceAdd
import dev.mjpark.krtv.data.ReqSources
import dev.mjpark.krtv.data.RespSettings
...
class SimpleServer(private val context: Context, private val viewModel: MainViewModel) :
    ...
    private fun handleSources(): Response {
        val response = runBlocking(Dispatchers.IO) {
            fetchSources("https://raw.githubusercontent.com/mjpark-dev/KRTV/main/app/src/main/res/raw/sources.txt")
        }
